...
namespace Game_Sederhana
{
    public partial class Stage3 : Form
    {
        ...
        private void Stage3_Load(object sender, EventArgs e)
        {
            ...
            //musuh13
            msh.musuh13.Name = "musuh13";
            msh.musuh13.Width = 50;
            msh.musuh13.Height = 50;
            msh.musuh13.Location = new Point(310, 173);
            Bitmap gambar13 = new Bitmap(@"monster1.png");
            msh.musuh13.Image = (Image)gambar;
            msh.musuh13.SizeMode = PictureBoxSizeMode.Normal;
            msh.musuh13.Enabled = true;
            msh.musuh13.Visible = true;
            this.Controls.Add(msh.musuh13);
            //musuh14
        ...
        private void Stage3_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (musuh13)
            {
                msh.musuh13.Width -= 10;
                msh.musuh13.Height -= 10;
                if (msh.musuh13.Size.IsEmpty)
                {
                    this.Controls.Remove(msh.musuh13);
                    //timer1.Enabled = false;
                    //musuh4 = false;
                    hitungscore += 10;
                    label1.Text = "Score : " + hitungscore;
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            if (pelurubesar)
            {
                ...
                else if (peluru.Bounds.IntersectsWith(msh.musuh13.Bounds))
                {

                    msh.musuh13.Image = null;
                    Bitmap gambarslime = new Bitmap(@"slimehitam.png");

                    msh.musuh13.Image = (Image)gambarslime;
                    SoundPlayer main = new SoundPlayer(@"Splat Sounds - Free Sound Effects - Splat Sound Clips - Sound Bites.wav");
                    main.Play();
                    pelurubesar = false;
                    timer2.Enabled = false;
